...
function controlar(){
	...
	if (sessionStorage.getItem("usrLogueado")) {
		...
		//if (sessionStorage.getItem("usrIntentando")) {
	...
	function validarXML() {
	  ...
	  xhr.open("GET", "https://guadalfredogames.github.io/publico/proyectoweb/validacionUsuarios.xml", true);
	  xhr.send();
	}
	...
	function miFuncion(xml) {
	  ...
	  for (i = 0; i <x.length; i++) { 
		...
		if ((usrNom == sessionStorage.getItem("usrIntentando")) && (usrPsw == sessionStorage.getItem("claveIntentando"))) {
